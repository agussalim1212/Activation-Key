...
namespace System.Security.Activation
{
    ...
    public class ActivationKeyBinaryParser : ICloneable
    {
        ...
        /// </summary>
        /// <param name="reader">
        ///     A reader from the stream containing key activation data.
        /// </param>
        /// <returns>
        ...
        /// </summary>
        /// <param name="stream">
        ///     A stream containing key activation data.
        /// </param>
        /// <returns>
        ///     An instance of <see cref="ActivationKey"/> instance containing the parsed data.
        /// </returns>
        ...
        ///     Thrown when the stream is not readable or contains no data.
        /// </exception>
        public ActivationKey Parse(Stream stream)
        {
            ...
            using (BinaryReader reader = new BinaryReader(stream))
            {
                ActivationKey activationKey = Parse(reader);
                return activationKey;
            }
        }
        ...
        /// </summary>
        /// <param name="bytes">
        ///     A byte array containing key activation data.
        /// </param>
        /// <returns>
        ///     An instance of <see cref="ActivationKey"/> instance containing the parsed data.
        /// </returns>
        /// <exception cref="ArgumentException">
        ///     Thrown if array is null or empty.
        /// </exception>
        ...
        /// </param>
        /// <exception cref="ArgumentNullException">
        ///     Thrown if one of arguments is null.
        /// </exception>
        ...
        /// </exception>
        /// <exception cref="ArgumentException">
        ///     Thrown if output stream is not writable.
        /// </exception>
        ...
        /// </summary>
        /// <param name="activationKey">
        ///     An instance of <see cref="ActivationKey"/> to convert.
        /// </param>
        /// <returns>
        ///     Byte array representing the <see cref="ActivationKey"/> object.
        /// </returns>
        /// <exception cref="ArgumentNullException">
        ///     Thrown if activation key is null.
        /// </exception>
