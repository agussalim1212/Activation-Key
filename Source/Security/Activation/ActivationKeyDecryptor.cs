...
namespace System.Security.Activation
{
    ...
    public sealed class ActivationKeyDecryptor : IDisposable
    {
        ...
        /// <summary>
        ///     Returns true if the data was successfully decrypted.
        ///     False means the key failed verification.
        /// </summary>
        ...
        // Decrypts the data contained in the activation key
        // using the specified encryption and hashing algorithm.
        ...
        ///     The activation key to be verified.
        /// </param>
        /// <param name="environment">
        ///     Environment binding parameters used to generate the key.
        ///     These parameters can be used to create a unique activation key
        ///     that can be used to authenticate a user or device.
        /// </param>
        /// <exception cref="ArgumentNullException">
        ///     Trows if argument <paramref name="activationKey"/> is null.
        /// </exception>
            ...
            ActivationKey activationKey, params object[] environment)
        {
            ...
            try
            {
                ...
                using (ICryptoTransform decryptor =
                       symmetricAlgorithm.CreateDecryptor(deriveBytes.GetBytes(symmetricAlgorithm.KeySize / 8), seed))
                {
        ...
        /// <summary>
        ///     Returns a <see cref="BinaryReader"/> object that can be used
        ///     to read the decrypted data stored to the activation key.
        /// </summary>
        /// <returns>
        ...
        public BinaryReader GetBinaryReader()
        {
            ...
            BinaryReader binaryReader = new BinaryReader(new MemoryStream(Data, false));
            return binaryReader;
        }

        /// <summary>
        ///     Returns a <see cref="TextReader"/> object that can be used
        ///     to read the decrypted data stored to the activation key.
        /// </summary>
        /// <param name="encoding">
        ...
        public TextReader GetTextReader(Encoding encoding = null)
        {
            ...
            TextReader textReader = new StreamReader(new MemoryStream(Data, false), encoding ?? Encoding.UTF8);
            return textReader;
        }
